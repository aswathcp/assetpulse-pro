    ...
    try {
      ...
      for (var a in _filteredAssets) {
        sheet.appendRow([
          ...
          TextCellValue(a.dutyCycle ?? ''),
          TextCellValue(a.insulationClass ?? ''),
          TextCellValue(a.efficiencyClass ?? ''),
          TextCellValue(a.ipRating ?? ''),
          TextCellValue(a.couplingAvailable ?? ''),
          TextCellValue(a.couplingType ?? ''),
